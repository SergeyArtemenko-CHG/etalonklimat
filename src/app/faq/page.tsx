  ...
  return (
    <ContentLayout title="Частые вопросы">
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-primary">Личный кабинет</h2>

        <div className="space-y-2">
          <h3 className="font-medium text-text-main">Как создать аккаунт на сайте?</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="font-medium text-text-main">Какие возможности дает личный кабинет?</h3>
          <p>
